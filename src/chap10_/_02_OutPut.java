...
public class _02_OutPut {
    public static void main(String[] args) {
        ...
        System.out.printf("%06d%n", 1234); // 001234 (6자리의 공간 확보 후 1234 출력하는데 빈 공간을 0으로 채움)
        System.out.printf("%6d%n", -1234); // _-1234
        System.out.printf("%+6d%n", 1234); // _+1234 (항상 +- 기호 표시)
        System.out.printf("%,15d%n", 1000000000); // __1,000,000,000 (15자리 공간을 확보 후 세자리마다 ,로 구분)
        System.out.printf("%-6d%n", 1234); // 1234__ (6자리의 공간을 확보 후 왼쪽 정렬 1234 출력)

        System.out.println("------ 실수 ------");
        System.out.printf("%f%n", Math.PI); // 3.141593 (일반 출력)
        System.out.printf("%.2f%n", Math.PI); // 3.14 (소수점 둘째자리까지 즉, 셋째자리에서 반올림 한 값)
        System.out.printf("%6.2f%n", Math.PI); // __3.14 (6자리 공간 확보하고 나서 소수점 둘째자리)
